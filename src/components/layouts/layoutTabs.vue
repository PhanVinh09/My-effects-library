<template>
  ...
  <div>
    ...
    <div v-if="activeTab === 'html'" class="tab-content">
      <pre><code class="language-html" v-html="formatHtmlCode(layout.html)"></code></pre>
    </div>
    <div v-else-if="activeTab === 'css'" class="tab-content">
      <pre><code class="language-css" v-html="formatCode(layout.css)"></code></pre>
    </div>
...
export default {
  ...
  computed: {
    tabs() {
      const baseTabs = []
      if (this.layout.html?.trim()) baseTabs.push('html')
      if (this.layout.css?.trim()) baseTabs.push('css')
      if (this.layout.js?.trim()) baseTabs.push('js')
  ...
  methods: {
    ...
    copyToClipboard() {
      ...
      if (this.activeTab === 'html') {
        ...
        content = this.formatPlainCode(this.layout.css)
      } else if (this.activeTab === 'js') {
        content = this.formatPlainCode(this.layout.js)
      } else {
