...
<div class="content">
    <div class="table-container">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Nút Sửa -->
                        <button class="action-btn btn-edit" data-target="#editModal-{{ $ui->id_UI }}"><i class="bi bi-gear-fill"></i></button>
                    </td>
                </tr>
                ...
                <div id="editModal-{{ $ui->id_UI }}" class="modal">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('useInterfaces.update', $ui->id_UI) }}" method="POST">
                            ...
                            <label>Type</label>
                            <input type="text" list="ui-types" name="type" value="{{ $ui->type }}" maxlength="100" required />
                            ...
                            <label>Title</label>
                            <input type="text" name="title" value="{{ $ui->title }}" maxlength="255" required />

                            <label>Link</label>
                            <input type="text" name="link" value="{{ $ui->link }}" maxlength="60000" />

                            <label>HTML</label>
                            <input type="text" name="html" value="{{ $ui->html }}" maxlength="60000" />

                            <label>CSS</label>
                            <input type="text" name="css" value="{{ $ui->css }}" maxlength="60000" />

                            <label>JS</label>
                            <input type="text" name="js" value="{{ $ui->js }}" maxlength="60000" />
        ...
        <div class="status-summary">
            <span>Đang hiển thị {{ $useInterfaces->count() }} ui, tổng cộng {{ $useInterfaces->total() }} ui</span>
        </div>
    ...
    <div id="addModal" class="modal">
        <div class="modal-content">
            ...
            <form action="{{ route('useInterfaces.store') }}" method="POST">
                @csrf
                @auth
                <label>Author</label>
                ...
                <label>UI Name</label>
                <input type="text" name="ui_name" list="useInterfaces_name" value="{{ old('ui_name') }}" placeholder="Tên hiệu ứng..." maxlength="100" required />
                ...
                <label>Type</label>
                <input type="text" list="ui-types" name="type" value="{{ old('type') }}" placeholder="Hiệu ứng cho ..." maxlength="100" required />
                <datalist id="ui-types">
                    @foreach ($types as $type)
                    <option value="{{ $type }}">
                        @endforeach
